package com.mayhsupaing.movieshelf.activities.activities.networks;

import android.os.AsyncTask;
import android.util.Log;

import com.google.gson.Gson;
import com.mayhsupaing.movieshelf.activities.activities.MMMoviesApp;
import com.mayhsupaing.movieshelf.activities.activities.events.LoadedMovieEvent;
import com.mayhsupaing.movieshelf.activities.activities.networks.responses.GetMoviesResponse;
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Log.d(MMMoviesApp.LOG_TAG,"Response String"+responseString);

                    Gson gson=new Gson();
                    GetMoviesResponse getMoviesResponse=gson.fromJson(responseString, GetMoviesResponse.class);
                    Log.d(MMMoviesApp.LOG_TAG,"Get Movies Response Size"+getMoviesResponse.getPopularMovies().size());

                    EventBus.getDefault().post(new LoadedMovieEvent(getMoviesResponse.getPopularMovies()));
                } catch (Exception e) {
                    Log.e(MMMoviesApp.LOG_TAG,e.getMessage());
                    /*
